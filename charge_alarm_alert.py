        ...
        if self.is_monitoring:
            try:
                ...
                if not charger_connected:
                    ...
                    elif battery_percentage >= 90 and battery_percentage < 100 and not self.alarm_90_triggered and not self.alarm_stopped_due_to_disconnection: # all conditions include
